...
(() => {
    ...
    const actions = enumOf([
        ...
        'SET_WORKERS_STOPPED', 'SET_DOWNLOADS_PAUSED', 'SET_COLLECTION_DOWNLOADS_PAUSED',
        'PAUSE_DOWNLOAD', 'RESUME_DOWNLOAD', 'RETRY_DOWNLOAD',
        'RETRY_FAILED_COLLECTION_DOWNLOADS', 'REMOVE_COMPLETED_TRACK',
        'REMOVE_COMPLETED_JOB', 'CLEAR_COMPLETED_DOWNLOAD_HISTORY',
    ]);
